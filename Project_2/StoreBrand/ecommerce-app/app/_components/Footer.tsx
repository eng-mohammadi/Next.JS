...
import { categories, Category } from "../_data/products";
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-8 md:mb-0 md:max-w-xl">
                ...
                <p className="text-white/80">
                  Get the latest products, promotions, and tech news delivered
                  to your inbox.
                </p>
              </div>
              <div className="w-full md:w-auto">
                <form className="flex flex-col sm:flex-row gap-2">
                  ...
                  <button
                    type="submit"
                    className="bg-[#edae49] hover:bg-[#edae49]/90 text-white px-6 py-3 rounded-lg transform hover:scale-105 font-medium flex items-center justify-center transition-all"
                  >
        ...
        <div className="max-w-7xl mx-auto py-16">
          <div className="grid grid-cols md:grid-cols-12 gap-8">
              ...
              <ul className="space-y-2.5">
                {categories.slice(0, 5).map((category) => (
                  <li key={category.slug}>
                    <Link
                      href="/products"
                      className="text-gray-500 hover:text-[#00798c] hover:translate-x-1 inline-flex items-center transition-all"
                    >
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  <li key={item}>
                    <a
                      href="#"
                      className="text-gray-500 hover:text-[#00798c] hover:translate-x-1 inline-block transition-all"
                    >
                      {item}
                    </a>
                  </li>
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <ul className="space-y-2.5">
                {["About Us", "Blog", "Career", "Press", "Privacy Policy"].map(
                  (item) => (
                    <li key={item}>
                      <a
                        href="#"
