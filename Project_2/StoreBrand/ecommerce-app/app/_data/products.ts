...
export const productsList: Product[] = [
  ...
  // TVs
  {
    ...
    price: 1299,
    description:
      "A stunning 4K UHD television with an immersive viewing experience.",
  ...
  },
  {
    ...
    price: 1599,
    description:
      "An OLED TV with perfect blacks and vibrant colors for the best experience.",
  ...
  },
  {
    ...
    price: 2999,
    description:
      "A revolutionary 8K curved TV with AI-enhanced picture quality.",
  ...
  // Laptops
  {
    ...
    price: 1899,
    description:
      "A high-end gaming laptop with an RTX 4090 GPU and 240Hz display.",
  ...
  },
  {
    ...
    price: 1299,
    description:
      "A sleek and powerful laptop designed for productivity and business users.",
  ...
  // Smartwatches
  {
    ...
    price: 399,
    description:
      "A sleek and stylish smartwatch with health tracking features.",
  ...
  },
  {
    ...
    price: 499,
    description:
      "Built for durability and extreme conditions with GPS tracking.",
  ...
  },
  {
    ...
    price: 899,
    description:
      "A premium smartwatch with a titanium build and sapphire crystal display.",
  ...
  // Cameras
  {
    ...
    price: 1499,
    description:
      "High-resolution DSLR camera with advanced shooting features for professionals.",
  ...
  },
  {
    ...
    price: 1199,
    description:
      "Compact mirrorless camera with 4K video recording and interchangeable lenses.",
  ...
  },
  {
    ...
    price: 349,
    description:
      "Waterproof action camera for capturing your adventures in stunning detail.",
  ...
  // Tablets
  {
    ...
    price: 899,
    description:
      "High-performance tablet with a stunning display and powerful processor.",
  ...
  },
  {
    ...
    price: 649,
    description:
      "Specialized tablet for digital artists with pressure sensitivity.",
  ...
  },
  {
    ...
    price: 399,
    description:
      "Portable tablet that fits in your pocket with all-day battery life.",
  ...
  },
  {
    ...
    price: 129,
    description:
      "Waterproof portable speaker with up to 20 hours of battery life.",
  ...
  },
  {
    ...
    price: 499,
    description:
      "High-fidelity soundbar with wireless subwoofer for immersive home theater audio.",
